...
void main() {
	...
	float attenuation = 1.0 / (1.0 + 0.08 * distanceToLight + 0.02 * distanceToLight * distanceToLight);
	float lightAmount = 0.18 + diffuse * attenuation * 5.5;
	lightAmount = clamp(lightAmount, 0.18, 1.0);
